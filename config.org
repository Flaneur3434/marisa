...
#+BEGIN_SRC emacs-lisp
  (defun xah-syntax-color-hex ()
    "Syntax color text of the form ¡Ö#ff1100¡× and ¡Ö#abc¡× in current buffer.
  ...
  (setq eshell-prompt-function
        (lambda nil
          (concat
           ...
           (if (= (user-uid) 0)
               (propertize " ¦Á " 'face `(:foreground "#FF6666"))
           (propertize " ¦Ë " 'face `(:foreground "#A6E22E"))))))
...
#+END_SRC
*** Historical
22/04/2019: This macro was provided by user [[https://gist.github.com/ld34/44d100b79964407e5ddf41035e3cd32f][ld43]] after I couldn¡Çt figure out how to make diminish work by being at the top of the config file.
