...
#+BEGIN_SRC emacs-lisp
  (use-package company
    ...
    (setq company-idle-delay nil
          ...
          company-backends '(company-files company-capf company-ctags company-abbrev)))
...
#+BEGIN_SRC emacs-lisp
  (use-package irony
    ...
    (irony-mode . yas-minor-mode)
    (irony-mode . openbsd-set-knf-style)
    (irony-mode . undo-hl-mode)
    (irony-mode . wrap-region-mode))
  ...
  (defun trivialfis/irony ()
    ...
    (add-to-list 'company-backends
                 '(company-irony company-irony-c-headers :seperate) t)
