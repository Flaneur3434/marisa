...
#+BEGIN_SRC emacs-lisp
  (global-set-key (kbd "C-r") 'ken_nc/edit-grep-buffer-dwim)
#+END_SRC
Default grep flags
#+BEGIN_SRC emacs-lisp
  (grep-apply-setting
...
#+BEGIN_SRC emacs-lisp
  (defun activate-default-input-method ()
    (interactive)
    ;; need emacs-mozc to be installed
...
#+BEGIN_SRC emacs-lisp
  (use-package company
    ...
    (define-key company-active-map (kbd "l") #'company-select-previous)
    (define-key company-active-map (kbd "<home>") #'company-abort)
    (global-company-mode))
#+END_SRC
** C & C++
*** Description
