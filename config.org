...
** Crux keybinds
#+BEGIN_SRC emacs-lisp
  ;; (defun ken_nc/open-newline-above ()
  ;;   (interactive)
  ;;   (save-excursion
  ;;     (beginning-of-line)
  ;;     (insert hard-newline)))

  ;; (defun ken_nc/open-newline-below ()
  ;;   (interactive)
  ;;   (save-excursion
  ;;     (end-of-line)
  ;;     (insert hard-newline)))
  ...
  ;; (key-chord-define-global "ss" 'ken_nc/open-newline-below)
  ;; (key-chord-define-global "SS" 'ken_nc/open-newline-above)
