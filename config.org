...
#+BEGIN_SRC emacs-lisp
  ...
  (push '(font . "mononoki:size=14") default-frame-alist)
...
#+END_SRC
** Aliases
Ask Bash for the list of currently available aliases instead of parsing .bashrc file. Might have errros as it was not made professionally.
Also to execute external commands, put a '*' infront
https://www.gnu.org/software/emacs/manual/html_node/eshell/Built_002dins.html
#+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  (use-package flycheck
    ...
    ((c-mode c++-mode java) . flycheck-mode))
  ...
  (add-hook 'flycheck-mode-hook 'trivialfis/flycheck)
  (setq shell-command-switch "-lc") ;; flycheck doesnt work for some reason
#+END_SRC
** Initialize =company=
#+BEGIN_SRC emacs-lisp
  (use-package company
